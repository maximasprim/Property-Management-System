...
import { createUser, getSingleUser, listUsers, updateUser, deleteUser,listsingleuserwithBooking,listSingleUserWithTickets} from "./user.controller";
...
userRouter.get("/users/withPayments/:id", listSingleUserWithTickets)  