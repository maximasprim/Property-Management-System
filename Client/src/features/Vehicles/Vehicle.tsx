      ...
      {selectedVehicle ? (
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                {selectedVehicle.vehicle_history && selectedVehicle.vehicle_history.length > 0 ? (
                  <ul className="text-gray-600 text-sm mt-2">
                    {selectedVehicle.vehicle_history.map((history: VehicleHistory) => (
                      <li key={history.history_id} className="mb-2">
                        ...
                        {history.maintenance_type && (
                          <>
                            ...
                            {history.maintenance_date}) <br />
                          </>
                        )}
                        {history.tenant_name && (
                          <>
                            <span className="font-bold">Tenant:</span> {history.tenant_name} (
                            {history.lease_start} - {history.lease_end}) <br />
                          </>
                        )}
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 md:px-10">
            {vehicles &&
              vehicles.slice(0, visibleCount).map(
                (vehicle) =>
                  vehicle &&
                  vehicle.images &&
